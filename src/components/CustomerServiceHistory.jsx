...
export default function CustomerServiceHistory({ profile }) {
  ...
  async function load() {
    ...
    if (!customer) { setItems([]); setLoading(false); return }
