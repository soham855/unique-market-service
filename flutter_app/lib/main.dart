          ...
          child: ConstrainedBox(
            ...
            child: Column(
              ...
              children: [
                ...
                const Text('Instant Services', style: TextStyle(fontSize: 32, fontWeight: FontWeight.w900)),
                const SizedBox(height: 6),
                const Text('Secure access to your service portal', style: TextStyle(color: Colors.white60)),
        ...
        children: [
          Container(
            ...
            decoration: BoxDecoration(
              ...
              gradient: const LinearGradient(colors: [Color(0xFF102A38), Color(0xFF0D1722)]),
            ...
            child: Column(
              ...
              children: [
                ...
                const Text('Connected to Unique Market Service backend.', style: TextStyle(color: Colors.white60)),
              ],
            ),
          ),
